...
public class ClienteDAO implements IClienteDAO {
    ...
    private String getSqlInsert() {
        ...
        sb.append("INSERT INTO tarefa_m29.cliente (ID, CODIGO, NOME) ");
        sb.append("VALUES (nextval('tarefa_m29.SQ_CLIENTE'), ?, ?)");
        return sb.toString();
    }
    ...
    private String getSqlUpdate() {
        StringBuilder sb = new StringBuilder();
        sb.append("UPDATE tarefa_m29.cliente ");
    ...
    private String getSqlDelete() {
        StringBuilder sb = new StringBuilder();
        sb.append("DELETE FROM tarefa_m29.cliente ");
    ...
    private String getSqlSelect() {
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT * FROM tarefa_m29.cliente ");
        sb.append("WHERE CODIGO = ?");
        return sb.toString();
    }
